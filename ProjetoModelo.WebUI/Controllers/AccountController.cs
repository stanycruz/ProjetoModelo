...
using ProjetoModelo.WebUI.Identity;
...
namespace ProjetoModelo.WebUI.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        /// <summary>
        /// Definindo a instância UserManager presente no request.
        /// </summary>
        ...
        /// <summary>
        /// Definindo a instância SignInManager presente no request.
        /// </summary>
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await UserManager.SendEmailAsync(user.Id, "Confirme sua Conta", "Por favor confirme sua conta clicando <a href=\"" + callbackUrl + "\">neste link</a>.");
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    // Não revelar se o usuario não existe ou não esta confirmado
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                case SignInStatus.Failure:
                default:
                    // Se ele não tem uma conta solicite que crie uma
